            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-lg-4 bio-row">
                        <p><span class="bold"><i class="fa fa-laptop"></i> <?= lang('reparation_imei'); ?> </span><span
                                    id="rv_imei"></span></p>
                    </div>
                    <div class="col-md-12 col-lg-4 bio-row">
                        <p><span class="bold"><i class="fa fa-user"></i> <?= lang('client_title'); ?></span><span
                                    id="rv_client"></span></p>
                    </div>
                    <div class="col-md-12 col-lg-4 bio-row stato">
                        <p><span class="bold"><i
                                        class="fa fa-signal"></i> <?= lang('reparation_condition'); ?> </span><span
                                    class="label" id="rv_condition"></span></p>
                    </div>
                    <div class="col-md-12 col-lg-4 bio-row">
                        <p><span class="bold"><i
                                        class="fa fa-calendar"></i> <?= lang('reparation_opened_at'); ?> </span><span
                                    id="rv_created_at"></span></p>
                    </div>
                    <div class="col-md-12 col-lg-4 bio-row">
                        <p><span class="bold"><i class="fas fa-link"></i> <?= lang('reparation_defect'); ?> </span><span
                                    id="rv_defect"></span></p>
                    </div>
                    <div class="col-md-12 col-lg-4 bio-row">
                        <p><span class="bold"><i
                                        class="fa fa-sitemap"></i> <?= lang('reparation_category'); ?> </span><span
                                    id="rv_category"></span></p>
                    </div>
                    <div class="col-md-12 col-lg-4 bio-row">
                        <p><span class="bold"><i
                                        class="fa fa-desktop"></i> <?= lang('reparation_model'); ?> </span><span
                                    id="rv_model"></span></p>
                    </div>
                    <div class="col-md-12 col-lg-4 bio-row nofloat">
                        <p><span class="bold"><i
                                        class="fas fa-money-bill-alt"></i><?= lang('reparation_price'); ?> </span><span
                                    id="rv_price"></span></p>
                    </div>
                    <div class="col-md-12 col-lg-4 bio-row">
                        <p><span class="bold"><i class="fa fa-phone"></i> <?= lang('client_telephone'); ?> </span><span
                                    id="rv_phone_number"></span></p>
                    </div>
                    <div class="col-md-12 col-lg-4 bio-row">
                        <p><span class="bold"><i class="glyphicon glyphicon-qrcode"></i> <?= lang('reparation_code'); ?> </span><span
                                    id="rv_rep_code"></span></p>
                    </div>
                    <div class="col-md-12 col-lg-4 bio-row nofloat">
                        <p><span class="bold"><i class="fas fa-retweet"></i><?= lang('warranty'); ?> </span><span
                                    id="rv_warranty"></span></p>
                    </div>
                    <?php
                    ...
                    foreach ($custom_fields as $line) {
                        if (!empty($line)) {
                            ?>
                            <div class="col-md-12 col-lg-4 bio-row">
                                <p><span class="bold"><i class="fa fa-info-circle"></i> <?= $line; ?> </span><span
                                            class="show_custom" id="v<?= bin2hex($line); ?>"></span></p>
                            </div>
                        <?php }
                    } ?>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6 bio-row fastsms">
                        <div class="form-group rv_comment">
                            ...
                            <textarea class="form-control" id="fastsms" rows="6"
                                      placeholder="Instantly send a text message to the client by entering your text here"></textarea>
                            <button type="button" class="btn btn-xs btn-primary" id="sendsmsfast"><i
                                        class="fa fa-check"></i> <?= lang('send'); ?></button>
                        </div>
                    </div>
                </div>
                <div id="timeline"></div>
            ...
            <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <i class="fas fa-laptop"></i></span>
                                                    ...
                                                    <input id="imei" name="imei" type="text"
                                                           class="validate form-control imei_typeahead">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-4 col-xs-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select required id="client_name" name="client_name" data-num="1"
                          ...
                          <i class="fa  fa-folder"></i></span>
                                                ...
                                                <input id="category" name="category" type="text"
                                                       class="validate form-control categories_typeahead">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-4 col-xs-12 col-md-4">
                                    ...
                                    <div class="col-lg-4 col-sm-4 col-xs-12 col-md-4">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control manufacturer_name_typeahead"
                                                       id="reparation_manufacturer" name="manufacturer" required="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-4 col-xs-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control model_name_typeahead" id="reparation_model"
                                                   name="model" required="">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-4 col-xs-12 col-md-4">
                            ...
                            <i class="fas fa-link"></i></span>
                                                    ...
                                                    <input required id="defect" name="defect" type="text"
                                                           class="validate form-control defect_typeahead">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                          ...
                          <i class="fas fa-truck"></i></span>
                                                ...
                                                <input required id="service_charges" name="service_charges" min="0"
                                                       type="number" value="0" step="any" class="validate form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-4 col-sm-4 col-xs-12 col-md-4">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="expected_close_date_"
                                                         data-target-input="nearest">
                                                        <div class="input-group-append"
                                                             data-target="#expected_close_date_"
                                                             data-toggle="datetimepicker">
                                                            <div class="input-group-text"><i class="fa fa-calendar"></i>
                                                            </div>
                                                        </div>
                                                        <input id="expected_close_date"
                                                               data-target="#expected_close_date_"
                                                               name="expected_close_date" type="text"
                                                               class="validate form-control datetimepicker-input">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-sm-4 col-xs-12 col-md-4">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="date_of_purchase_"
                                                         data-target-input="nearest">
                                                        <div class="input-group-append" data-target="#date_of_purchase_"
                                                             data-toggle="datetimepicker">
                                                            <div class="input-group-text"><i class="fa fa-calendar"></i>
                                                            </div>
                                                        </div>
                                                        <input id="date_of_purchase" data-target="#date_of_purchase_"
                                                               name="date_of_purchase" type="text"
                                                               class="validate form-control datetimepicker-input">
                                                    </div>
                                                </div>
                                            </div>
                          ...
                          <i class="fas fa-retweet"></i></span>
                            ...
                            <i class="fas fa-retweet"></i></span>
                                                        ...
                                                        <input required id="warranty_card_number"
                                                               name="warranty_card_number" type="text"
                            ...
                            <i class="fas fa-wrench"></i></span>
                                                        ...
                                                        <input id="repair_type" name="repair_type" type="text"
                                                               class="validate form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-sm-4 col-xs-12 col-md-4">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="client_date_"
                                                         data-target-input="nearest">
                                                        <div class="input-group-append" data-target="#client_date_"
                                                             data-toggle="datetimepicker">
                                                            <div class="input-group-text"><i class="fa fa-calendar"></i>
                                                            </div>
                                                        </div>
                                                        <input id="client_date" data-target="#client_date_"
                                                               name="client_date" type="text"
                                                               class="validate form-control datetimepicker-input">
                                                    </div>
                                    ...
                                    foreach ($custom as $line) {
                                        if (!empty($line)) {
                                            ...
                                            <div class="col-lg-4 col-sm-4 col-xs-12 col-md-4">
                                                <div class="form-group">
                                                    <label><?= $line; ?></label>
                                                    <input id="custom_<?= bin2hex($line); ?>"
                                                           name="custom_<?= bin2hex($line); ?>" type="text"
                                                           class="custom validate form-control">
                                                </div>
                                            </div>
                                        <?php }
                                    } ?>
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <select id="potax2" class="form-control input-tip select" name="order_tax"
                                            style="width: 100%;">
                                ...
                                <div class="control-group table-group">
                                    ...
                                    <div class="controls table-controls">
                                        ...
                                        <table class="table items table-striped table-bordered table-sm table-hover">
                                            <tfoot>
                                            <tr>
                                                <th colspan="1" class="warning"><span
                                                            class="pull-right"><?= lang('tax'); ?></span></th>
                                                <th colspan="1" class="success"><span id="tax_span">0.00</span></th>
                                                <th colspan="1" class="warning"><span
                                                            class="pull-right"><?= lang('subtotal') ?></span></th>
                                                <th colspan="1" class="info"><span id="price_span">0.00</span></th>
                                            </tr>
                                            <tr style="display: none;">
                                                <th colspan="5" class="warning"><span
                                                            class="pull-right"><?= lang('total'); ?></span></th>
                                                <th colspan="1" class="success"><span id="totalprice_span">0.00</span>
                                                </th>
                                            </tr>
                                            <tr>
                                                <th colspan="1" class="warning"><span
                                                            class="pull-right"><?= lang('reparation_service_charges') ?></span>
                                                </th>
                                                <th colspan="1" class="success"><span id="sc_span">0.00</span></th>
                                                <th class="warning"><span
                                                            class="pull-right"><?= lang('grand_total'); ?></span></th>
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6 col-xs-12 col-md-6">
                                        <div class="form-group">
                                            <?= lang('accessories', 'accessories'); ?> <i id="add_timestamp"
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-xs-12 col-md-6">
                                        <div class="form-group">
                                            <?= lang('reparation_comment', 'comment'); ?> <i id="add_timestamp"
                                                                                             class="fa fa-calendar"></i>
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-xs-12 col-md-6">
                                        <div class="form-group">
                                            <?= lang('reparation_diagnostics', 'diagnostics'); ?> <i id="add_timestamp"
                                                                                                     class="fa fa-calendar"></i>
                                            <textarea class="form-control" id="diagnostics" name="diagnostics"
                                                      rows="6"></textarea>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    ...
                    <i class="fas fa-pencil-alt"></i></span>
                        ...
                        <div class="col-md-1">
                            <input id="code" type="text" class="validate form-control" value=""
                                   placeholder="<?= lang('reparation_code'); ?>">
                        </div>

                        <div class="col-md-8 pull-right" id="footerReparation"></div>
                    </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <center>
                    <button id="submit_sign" data-mode="update_sign"
                            class="btn-icon btn btn-success "><?= lang('save'); ?></button>
...
<script type="text/javascript">
    ...
    jQuery(".add_reparation").on("click", function (e) {
        ...
        footer = '';
        footer += '<button id="upload_modal_btn" class="btn btn-sm btn-success" data-mode="add"><i class="fa fa-cloud"></i> <?=lang('upload_file');?></button>';
        footer += '<span class="badge badge-info label-xs btn btn-sm btn-info ml-1" ><?=lang('reparation_sms', 'repair_sms');?><input type="checkbox" value="1" name="sms" id="repair_sms"></span><span class=" badge badge-warning label-xs btn btn-warning btn-sm ml-1"><label for="repair_email"><?=lang('send_email_check');?></label><input type="checkbox" value="1" name="email" id="repair_email"></span><button class="btn btn-sm btn-primary ml-1" id="sign_repair" href="#signModal" data-toggle="modal" data-mode="add_signature"><i class="fas fa-signature"></i> <?=lang('sign_repair');?></button><button href="#prerepair" class="prerepair_show btn btn-primary btn-sm  ml-1"><i class="fa fa-plus-circle"></i> <?=lang('pre_repair_checklist');?></button><button id="repair_submit"  role="button" form="rpair_form"  class="btn btn-success btn-sm  ml-1" data-mode="add"><i class="fa fa-user"></i> <?= lang("add"); ?> <?= lang("reparation_title"); ?></button>';
                    ...
                    <form id="model_form" class="col s12">
                        <div class="row">
                            <div class="col-md-12 col-lg-6 input-field">
                                ...
                                <div class="form-line">
                                    <select class="form-control" id="model_name" name="name[]" required="" multiple
                            ...
                            <div class="col-md-12 col-lg-6 input-field">
                                ...
                                <div class="form-line">
                                    <input class="form-control manufacturer_name_typeahead" id="manufacturer_name"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-lg-6 bio-row">
                            <p><span class="bold"><i class="fa fa-user"></i> <?= lang('client_name'); ?> </span><span
                                        id="v_name"></span></p>
                        </div>
                        <div class="col-md-12 col-lg-6 bio-row">
                            <p><span class="bold"><i class="fa fa-user"></i> <?= lang('client_company'); ?> </span><span
                                        id="v_company"></span></p>
                        </div>
                        <div class="col-md-12 col-lg-6 bio-row">
                            <p><span class="bold"><i class="fa fa-road"></i> <?= lang('client_address'); ?></span><span
                                        id="v_address"></span></p>
                        </div>
                        <div class="col-md-12 col-lg-6 bio-row">
                            <p><span class="bold"><i class="fa fa-globe"></i><?= lang('client_city'); ?></span><span
                                        id="v_city"></span></p>
                        </div>
                        <div class="col-md-12 col-lg-6 bio-row">
                            <p>
                ...
                <?= lang('client_postal_code'); ?>
                        ...
                        <div class="col-md-12 col-lg-6 bio-row">
                            <p><span class="bold"><i
                                            class="fa fa-phone"></i> <?= lang('client_telephone'); ?> </span><span
                                        id="v_telephone"></span></p>
                        </div>
                        <div class="col-md-12 col-lg-6 bio-row">
                            <p><span class="bold"><i
                                            class="fa fa-envelope"></i> <?= lang('client_email'); ?> </span><span
                                        id="v_email"></span></p>
                        </div>
                        <div class="col-md-12 col-lg-6 bio-row">
                            <p><span class="bold"><i class="fa fa-barcode"></i> <?= lang('client_vat'); ?> </span><span
                                        id="v_vat"></span></p>
                        </div>
                        <div class="col-md-12 col-lg-6 bio-row">
                            <p><span class="bold"><i
                                            class="fa fa-quote-left"></i> <?= lang('client_ssn'); ?> </span><span
                                        id="v_cf"></span></p>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6 input-field">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="hidden" class="field form-control input-xs"
                    ...
                    <div class="col-md-12 col-lg-6 input-field">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="telephone" name="telephone" type="text" class="validate form-control"
                    ...
                    <div class="col-md-12 col-lg-12 input-field">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="image" type="file" data-browse-label="Browse" name="image"
                    ...
                    <div class="col-lg-4 input-field">
                        <div id="showIfImage" style="display: none;">
                            <button class="btn btn-primary" id="view_image_in" data-num><i class="fa fa-eye"></i>
                            </button>
                            <button class="btn btn-danger" id="delete_customer_image" data-num><i
                                        class="fa fa-trash-o"></i> <?= lang('delete') ?></button>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function showImage(url) {
        ...
        img.onload = function () {
            bootbox.dialog({
                message: "<a target='_blank' href='" + url + "'><center><img src='" + url + "'></center></a>",
                backdrop: true,
                onEscape: true
            }).find("div.modal-dialog").css({"width": (this.width) + 40 + "px"});
        }
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?= $settings->google_api_key ?>&libraries=places&callback=initAutocomplete"
        async defer></script>
<div class="modal modal-default-filled fade" id="prerepair" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                                        ...
                                        foreach ($repair_custom_toggles as $line): ?>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="checkbox-toggle-styled-on-off">
                                                    <input name="checktoggle_<?= bin2hex($line); ?>" type="hidden"
                                                           value="0">
                                                    <input name="checktoggle_<?= bin2hex($line); ?>"
                                                           id="checktoggle_<?= bin2hex($line); ?>" value="1"
                                                           type="checkbox">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link" id="one-tab-default-tab" data-toggle="pill"
                                               href="#one-tab-default" role="tab" aria-controls="one-tab-default"
                                               aria-selected="true"><?= lang('pin_code'); ?></a>
                                        </li>

                                        <li class="nav-item ">
                                            <a class="nav-link active" id="one-tab-default-tab" data-toggle="pill"
                                               href="#two-tab-default" role="tab" aria-controls="two-tab-default"
                                               aria-selected="true"><?= lang('pattern'); ?></a>
                                        </li>
