...
function check_add_barcode_item_val() {
    $('#add_barcode_item').bind('keypress', function (e) {
...
function Popup() 
{
    ...
    mywindow.document.write('<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/plugins/bootstrap/dist/css/bootstrap.min.css">');
...
function printContent(div_id){
        ...
        frameDoc.document.write('<link rel="stylesheet" href="<?= base_url(); ?>assets/plugins/bootstrap/dist/css/bootstrap.min.css">');
        frameDoc.document.write('<link rel="stylesheet" href="<?= $assets ?>dist/css/custom/barcode_print.css">');
