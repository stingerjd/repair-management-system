    ...
    <div class="row">
        <div class="col-md-7">
            ...
            <div class="form-inline p-3">
                <label for="quotation">
                    Quotation
                    <input type="radio" name="sales_type" class="form-control"  id="quotation" value="quotation">
                </label>
            </div>
            <div class="form-inline p-3">
                <label for="cash_sales">
                    Cash Sales
                    <input type="radio" name="sales_type" class="form-control"  id="cash_sales" value="cash_sales">
                </label>
            </div>
        </div>
